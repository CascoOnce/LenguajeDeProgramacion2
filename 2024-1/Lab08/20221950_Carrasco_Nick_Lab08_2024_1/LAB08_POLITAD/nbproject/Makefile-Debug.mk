...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab08_politad.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab08_politad.exe: libaperturadearchivosbibl.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab08_politad.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab08_politad ${OBJECTFILES} ${LDLIBSOPTIONS}
